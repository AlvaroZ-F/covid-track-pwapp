    ...
    var CovidService = /*#__PURE__*/function () {
      ...
      _createClass(CovidService, [{
        ...
        value: function getAll() {
          return this.http.get("".concat(this.apiUrl, "summary"));
        }
      }, {
        key: "getSpainTimespan",
        value: function getSpainTimespan(start_date, end_date) {
          return this.http.get("".concat(this.apiUrl, "country/spain/status/confirmed?from=").concat(start_date, "T00:00:00Z&to=").concat(end_date, "T00:00:00Z"));
        }
      }]);
